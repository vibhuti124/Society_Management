                            ...
                            <div className='container-fluid' >
                                ...
                                <div className='row py-3 card-row rounded'>
                                    <div className='pe-0 bg-light'>
                                        <div className='d-flex justify-content-between align-items-center py-3 px-3'>
                                            ...
                                            <Link to="/viewinvoice" className='text-decoration-none'>

                                                <button className='set-maintainance-btn d-flex align-items-center mainColor2 p-2' style={{borderRadius:"10px"}} onClick={handleShow}>
                                                ...
                                                <div className="col-lg-3 mb-3 " key={val.id}>
                                                    <div className="card">
                                                        <div className="card-header card-title text-light d-flex align-items-center justify-content-between py-3" style={{ background: "rgba(86, 120, 233, 1)" }}>
                                                            ...
                                                            <span className="badge1 Owner1 p-1 px-4" style={{borderRadius:"30px", background: "rgba(86, 140, 233, 1)"}}>Pending</span>
                                                        </div>
                                ...
                                >
                                    ...
                                    <div className="d-flex justify-content-between p-3 pt-0">
                                        ...
                                        <Button className="mainColor2 btn-confirm mt-2 save" onClick={handleShowCardDetailsModal}>
                                            Pay Now
                                        </Button>
                                    </div>
                                </Modal>
                                ...
                                >
                                    ...
                                    <div className="d-flex justify-content-between p-3 pt-0">
                                        ...
                                        <Button variant="warning" className="mainColor2 btn-confirm mt-2 save">
                                            Pay Now
                                        </Button>
                                    </div>
                                </Modal>
