                ...
                <div className='container-fluid stickyHeader'>
                    ...
                    <div className='row p-4 pe-3'>
                        ...
                        <div className="table-responsive rounded pb-3">
                            ...
                            <Link to="/personaldetail" className='btn btn-sm  maintainance-income-btn maintainance-income-btn-bg'>Owner</Link>

                            <Link to="/personaldetailstenant" className='btn btn-sm  maintainance-income-btn maintainance-income-btn-withoutbg'>Tenant</Link>
                                                    ...
                                                    <div className="card">
                                                        ...
                                                        <div className="card-body">
                                                            <div className='d-flex justify-content-between align-items-center mb-1'>
                                                                ...
                                                                <span classFName="card-body-title text-dark fw-medium">{val.name}</span>
                                                            </div>
                                                            <div className='d-flex justify-content-between align-items-center mb-1'>
