                ...
                <div className='container-fluid income stickyHeader' >
                    ...
                    <div className='row p-4 pe-3'>
                            ...
                            <div className="table-responsive rounded pb-3">
                                ...
                                <Link to="/personaldetail" className='btn btn-sm  maintainance-income-btn maintainance-income-btn-withoutbg'>Owner</Link>

                                <Link to="/personaldetailstenant" className='btn btn-sm  maintainance-income-btn  maintainance-income-btn-bg'>Tenant</Link>
