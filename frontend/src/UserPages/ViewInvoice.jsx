                                ...
                                <div>
                                    ...
                                    <table className="table">
                                        <thead className='table-primary'>
                                            <tr>
                                                <th className='text-center' scope="col">Invoice ID</th>
                                                <th className='text-center' scope="col">Due Date</th>
                                                <th className='text-center' scope="col">Payment Date</th>
                                                <th className='text-center' scope="col">Maintenance Amount</th>
                                                <th className='text-center' scope="col">Pending Amount</th>
                                        ...
                                        <tbody>
                                            {
                                                complaint.map((val, index) => {
                                                    return (
                                                        <tr key={index}>
                                                            <td className='text-center' style={{ height: '55px' }}>{val.id}</td>
                                                            <td className='text-center' style={{ height: '55px' }}>{val.bdate}</td>
                                        ...
                                        {viewComplaint && (
                                            <div>
                                                ...
                                                <div className="text-center mt-2 mb-2">
                                                    <Button variant="warning" className="px-4 save mainColor2 maintainance-income-btn-bg w-100">
