                                ...
                                <div className='container-fluid stickyHeader' >
                                    ...
                                    <div className='row py-3 card-row ' >
                                        <div className='pe-0 bg-light'>
                                            <div className='d-flex justify-content-between align-items-center py-3 px-3'>
                                                ...
                                                <button className='set-maintainance-btn d-flex mainColor2 align-items-center p-2' style={{borderRadius:"10px"}} onClick={handleShow}>
                                                    View Invoice
                                                </button>
                                            </div>
                                    ...
                                    >
                                        ...
                                        <div className="d-flex justify-content-between p-3 pt-0">
                                            ...
                                            <Button className="btn-confirm mainColor2 mt-2 save" onClick={handleShowCardDetailsModal}>
                                                Pay Now
                                            </Button>
                                        </div>
                                    </Modal>
