              ...
              <div className="table-responsive rounded pb-3">
                ...
                <div className='bg-light'>
                  <div className='d-flex justify-content-between align-items-center p-3 pt-1'>
                    <h3 className=' mb-0  financial-income-title text-xl font-bold'>Add Expenses Details</h3>

                    <div>
                      <button className='set-maintainance-btn d-flex align-items-center p-2' style={{ background: "linear-gradient(90deg, #FE512E 0%, #F09619 100%)"}} onClick={handleShow}> <FaPlusSquare className='me-2' /> Add New Expenses details</button>
                    </div>
                  </div>
