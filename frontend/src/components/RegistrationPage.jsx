...
function RegistrationPage() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (error.response && error.response.data && error.response.data.message) {
        ...
        // If no response or message is available, show a generic error
  ...
  if (!token) {
    toast.error('You are not logged in or the token is missing.');
    return;
  }
  
    try {
      const response = await axios.post('http://localhost:9000/api/society/create', societyData, {
        headers: {
          'Content-Type': 'application/json',
        },
      });
    ...
    <div className="registration-container">
      ...
      <div className="left-section">
        <div className="content text-center" style={{ marginTop: "60px" }}>
          ...
          <div className="container flex justify-center ">
            <img src={img} alt="Logo" className="img-fluid mt-5 pt-5" style={{ width: "550px" }} />
          </div>
        </div>
      </div>
      ...
      <div className="form-section">
        <div className="form-wrapper">
          <h2 style={{ color: "black",marginLeft:"-2px" }} className='text-start font-semibold text-4xl mb-3'>Registration</h2>
