...
function RequestTracking() {
  const [requests, setRequests] = useState([
    {
      ...
      description: "Providing false information or",
      date: "20/10/2002",
      unit: "A",
      number: "1001",
      priority: "Medium",
  ...
  const badgeStyle = (priority) => {
    ...
    if (priority === "Medium")
      return { backgroundColor: "#5678E9", color: "white" };
    if (priority === "Low")
      return { backgroundColor: "#39973D", color: "white" };
    return { backgroundColor: "#28a745", color: "white" };
  };

  const statusBadgeStyle = (status) => {
    if (status === "Pending")
      return { backgroundColor: " #FFC3131A", color: "#FFC313" };
    if (status === "Open")
      return { backgroundColor: "#5678E91A", color: "#5678E9" };
    if (status === "Solve")
      return { backgroundColor: "#39973D1A", color: "#39973D" };
  ...
  return (
    <div className="d-flex flex-column flex-md-row">
      ...
      <div className="flex-grow-1 dashboard-bg " style={{ width: "1920px" }}>
        <Header />
        <div
          className="container-fluid stickyHeader p-4"
          style={{ marginLeft: "295px", width: "1620px" }}
        >
          <div
          ...
          >
            <div className="d-flex flex-column flex-md-row justify-content-between align-items-center mt-2 mb-4">
              <h4 className="mb-0" style={{ marginLeft: "20px" }}>
                Request Tracking
              </h4>
              <Button
            ...
            <div
              className="flex-grow-1 dashboard-bg"
              style={{ width: "1920px" }}
            >
              <Modal>
                <Modal.Body>
                      ...
                      >
                        ...
                        >
                          ...
                          <Table
                            ...
                            hover
                            responsive
                            style={{ width: "1540px", marginLeft: "15px" }}
                          >
                                ...
                                >
                                  ...
                                  <p
                                    style={{
                                      ...
                                      padding: "2px 10px",
                                      borderRadius: "50px",
                                      backgroundColor: statusBadgeStyle(
                                        selectedRequest.status
                                      ).backgroundColor,
                                      color: statusBadgeStyle(
                                        selectedRequest.status
                                      ).color,
                                    }}
                                  >
